...
#if defined(GL_IMPORT_HACK)
#define glBindTexture(A,B)     (*pglBindTexture)(A,B)
#else
...
extern GLfloat fDxViewpoint;
extern GLfloat fDxImageShift;
...
#if 0	// ...skyfly.app/Contents/Resources
    unsigned char  path[255];

    getcwd(&path);
    err_msg(0, "init_texture_and_lighting()", path);
#endif
