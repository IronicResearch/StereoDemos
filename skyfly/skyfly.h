...
/* Watcom C 10 OpenGL32.LIB does not contain GL v1.1 imports! */
#if defined(__WATCOMC__) && (__WATCOMC__ <= 1100) && defined(__glut_h__)
#define GL_IMPORT_HACK
typedef void (__stdcall *PGLBINDTEXTURE)(GLenum, GLuint) ;
extern  PGLBINDTEXTURE pglBindTexture;
#endif
